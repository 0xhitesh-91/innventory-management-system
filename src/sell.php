...
<html>
    ...
    <body>
        ...
        <div id="purchase-party-detail">
            <label class="pur-party-label">Date - </label>
            <input class="pur-party-input" type="date" name="date" required="" >
            <label class="pur-party-label">Customer Name - </label>
            <input class="pur-party-input" type="text" name="cus_name" placeholder="Customer Name" required="" >
            <label class="pur-party-label">Mobile no - </label>
            <input class="pur-party-input" type="text" name="cus_mobile" placeholder="Mobile no" required="">
            <label class="pur-party-label">GST No - </label>
            <input class="pur-party-input" type="text" name="cus_gstno" placeholder="GST No" required="">
        ...
        <table id="pur-table-header">
            ...
            <input type="submit" name="sale-item-btn" value="Submit" class="submitbtn" style="width: 20%; margine-left: 200px;"/>
        </form>
